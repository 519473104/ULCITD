...
from convs.compact_resnet import compact_resnet8
import logging
...
def get_convnet(args, pretrained=False):
    ...
    if name == 'resnet32':
        return resnet32()
    elif name == 'conv1d_net10':
        return conv1d_net10(args=args)
    elif name == 'simple_cnn_bn':
        return simple_cnn_bn(args=args)
    elif name == 'compact_resnet8':
        return compact_resnet8(args=args)
    elif name == 'resnet10':
